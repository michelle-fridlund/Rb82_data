...
def find_patients(args):
    ...
    out1 = f'test_LightningAE_FAN2D_v2_TIODataModule_bz4_128x128x1_k0_e400_e=112.nii.gz'
    out2 = f'test_LightningAE_FAN2D_v3_TIODataModule_bz16_128x128x1_k0_e400_e=192.nii.gz'
    out3 = f'FAN_LightningAE_FAN2D_v4_TIODataModule_bz16_128x128x1_k0_e400_e=228.nii.gz'
