...
if __name__=="__main__":
    ...
    parser.add_argument('--data_path', '-d', dest='data_path', default= '/homes/michellef/Rb82/data/Dicoms_OCT8', help="dicom file directory")
    ...
    parser.add_argument('--whole_size', dest='whole_size', type=int,  default = 128, help='image whole size')
