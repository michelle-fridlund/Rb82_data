...
output = f'/homes/michellef/recon_im/{dose}_{mode.lower()}_rest_{patient}_norm_float32'
...
def load_ants(im_path):
    ...
    ants.plot(img, filename=f'/homes/michellef/my_projects/rb82_data/Dicoms_OCT8/Rb82_denoise_e100_bz1_lr0.0001_k0_predicted/{patient}/100p_{patient}.png', cmap='plasma')
