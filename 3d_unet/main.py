...
if __name__ == "__main__":
    ...
    parser.add_argument('--epoch', '-e', dest='epoch', type=int, default=600, help='number of training epochs')
    ...
    parser.add_argument('--norm', dest='norm', type=float, default=60193.9, help = 'PET normalisation factor')
    ...
    parser.add_argument('--lrs', dest='lrs', type=data.ParseBoolean,
                        default=False, help='use LRS: true, false')
